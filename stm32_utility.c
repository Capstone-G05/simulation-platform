...
const MessageMapping message_table[] = {
  ...
  { "UPU", WRITE, TYPE_PWM,  INDEX_PB0,    "Auger Pivot Up (W)"    },
  { "APD", READ,  TYPE_PWM,  INDEX_PA4,    "Auger Pivot Down"      },
  { "UPD", WRITE, TYPE_PWM,  INDEX_PA4,    "Auger Pivot Down (W)"  },
  { "AFU", READ,  TYPE_PWM,  INDEX_PB10,   "Auger Unfold"          },
  { "UFU", WRITE, TYPE_PWM,  INDEX_PB10,   "Auger Unfold (W)"      },
  { "AFF", READ,  TYPE_PWM,  INDEX_PB2,    "Auger Fold"            },
  { "AFF", WRITE, TYPE_PWM,  INDEX_PB2,    "Auger Fold (W)"        },
  { "STU", READ,  TYPE_PWM,  INDEX_PA1,    "Spout Tilt Up"         },
  { "STU", WRITE,  TYPE_PWM,  INDEX_PA1,    "Spout Tilt Up (W)"    },
  { "STD", READ,  TYPE_PWM,  INDEX_PA3,    "Spout Tilt Down"       },
  { "STD", WRITE,  TYPE_PWM,  INDEX_PA3,    "Spout Tilt Down (W)"  },
  { "SRC", READ,  TYPE_PWM,  INDEX_PA6,    "Spout Rotate CW"       },
  { "SRC", WRITE,  TYPE_PWM,  INDEX_PA6,    "Spout Rotate CW (W)"  },
  { "SRW", READ,  TYPE_PWM,  INDEX_PA7,    "Spout Rotate CCW"      },
  { "SRW", WRITE,  TYPE_PWM,  INDEX_PA7,    "Spout Rotate CCW (W)" },
  { "GTO", READ,  TYPE_PWM,  INDEX_PA5,    "Gate Open"             },
  { "GTO", WRITE,  TYPE_PWM,  INDEX_PA5,    "Gate Open (W)"        },
  { "GTC", READ,  TYPE_PWM,  INDEX_PB1,    "Gate Close"            },
  { "GTC", WRITE,  TYPE_PWM,  INDEX_PB1,    "Gate Close (W)"       },
